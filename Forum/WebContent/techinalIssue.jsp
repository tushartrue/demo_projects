...
<table width="416" border="0">
	<tr>
		...
		<td><span class="style32"><a
			href="technicalIssue.do?category_id=3&discussion_id=1 "><font
			size="2" color="#FF66FF" face="arial"> start a new discussion</font></a>
		| <span ><a
			href="searchtopic.do?category_id=3"><font
	...
	<tr>
		...
		<td><input name="Submit" type="submit" value="Submit" /> &nbsp; <input
			...
			href="technicalIssue.do?category_id=3&discussion_id=0">Hide</a></td>
	</tr>
	<%}
...
<%
            ...
            %>
 <form id="searchtopic" name="searchtopic" action="searchtopic.do?category_id=3&search_id=0" method="post" >  
    <table style="width: 498px">
        ...
        <tr>
            ...
            <td style="width: 289px">
                ...
                &nbsp;&nbsp; <a href="searchtopic.do?category_id=3&hide=0" >Hide</a></td>
            <td>
            </td>
        </tr>
...
<display:table class="gradiant" name="topicList" id="row"
	...
	sort="list" pagesize="2" requestURI="technicalIssue.do?category_id=3"
	style="width:100%">

	<display:column property="topic_name"
		href="detailTopic.do?category_id=3" paramId="t_id"
