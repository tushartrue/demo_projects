...
<form id="frmTopic" name="frmTopic" action="postTopic.do" method="post" onsubmit="return validate();">
 <table width="416" border="0">
		   <tr>
              ...
              <td>&nbsp;</td>
              <td><span class="style32"><a href="housing.do?category_id=1&discussion_id=1 "><font size="2" color="#FF66FF" face="arial"> start a new discussion</font></a> | 
              <span ><a
			href="searchtopic.do?category_id=1"><font
            ...
            <tr>
              ...
              <td><strong>:</strong></td>
              <td><textarea name="message" cols="50" rows="5" wrap="physical"></textarea>  &nbsp;</td>
            </tr>
            ...
            <tr>
              ...
              &nbsp; <input name="Clear" type="reset" value="Clear" /> &nbsp;&nbsp;&nbsp;&nbsp;<a href="housing.do?category_id=1&discussion_id=0" >Hide</a></td>
            </tr>
            <%} %>
          </table>	
          </form>	
	...
	<%
            ...
            %>
 <form id="searchtopic" name="searchtopic" action="searchtopic.do?category_id=1&search_id=0" method="post" >  
    <table style="width: 498px">
        ...
        <tr>
            ...
            <td style="width: 289px">
                ...
                &nbsp;&nbsp; <a href="searchtopic.do?category_id=1&hide=0" >Hide</a></td>
            <td>
            </td>
        </tr>
  ...
  <%} %>
	...
	%>
	 ...
	 <display:table  class="gradiant" name="topicList" id="row" excludedParams="*"  
							 cellpadding="6" cellspacing="0" export="false"  sort="list"  pagesize="2"  
							 requestURI="housing.do?category_id=1" style="width:100%" >
					
						<display:column    property="topic_name" 
										  href="detailTopic.do?category_id=1"  paramId="t_id" paramProperty="topic_id" scope="request" title="Topic" sortable="true" style="width: 250px;text-align: left;"  />
							
			<display:column property="user.name" title="Posted by" sortable="true" style="width: 100px;text-align: center;"/>
			
			
			
			<display:column property="repliesSize" title="Posts" sortable="true" style="width: 50px;text-align: center;"  />	
			
			
			
				    
	<display:column property="lastDate" title="Last Post" sortable="true" style="width: 100px;text-align: center;"   />
										
	<display:column property="strDate" title="Started Date" sortable="true" style="width: 120px;text-align: center;"  />
